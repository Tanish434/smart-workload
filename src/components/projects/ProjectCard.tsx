  ...
  return (
    <Card hoverable className="p-5 sm:p-6 flex flex-col justify-between relative group">
      <div>
        ...
        {/* Resource Expenditure Block */}
        <div className="p-3 rounded-2xl bg-slate-50 dark:bg-slate-800/60 border border-slate-100 dark:border-slate-700/60 space-y-2 mb-4">
          <div className="flex items-center justify-between text-xs">
            <span className="font-semibold text-slate-500 dark:text-slate-400 flex items-center gap-1.5">
              <Wallet className="w-3.5 h-3.5 text-emerald-500" />
              <span>Resource Expenditure</span>
            </span>
          ...
          <div className="w-full h-1.5 bg-slate-200 dark:bg-slate-700 rounded-full overflow-hidden">
            <div
              className="h-full bg-gradient-to-r from-emerald-500 via-indigo-500 to-violet-600 rounded-full transition-all duration-300"
              style={{ width: `${exp ? exp.burnRatePercent : project.completionPercent}%` }}
            />
          </div>
          ...
          <div className="flex items-center justify-between text-[11px] font-medium text-slate-500 dark:text-slate-400 pt-0.5">
            <span className="flex items-center gap-1">
              ...
              <span>{exp ? exp.completedHours : 0}h / {project.totalEstimatedHours}h burned</span>
            </span>
        ...
        {/* Lead & FTE Info */}
        <div className="flex items-center justify-between text-xs text-slate-500 dark:text-slate-400 mb-4 pt-2 border-t border-slate-100 dark:border-slate-800">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span>{exp ? exp.fteCommitment : 0} FTE ({exp ? exp.teamCapacityWeekly : 0}h/wk)</span>
          </div>
        </div>
      </div>
